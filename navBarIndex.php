...
<nav>
    ...
    <div class="upper-nav" id="upper-nav">
      ...
      <?php
        ...
        if (empty(isset($_SESSION['email']))) {
         ...
         echo '<a href="./html/register.php">Register</a>';
        ...
        <a href="./html/TS.php">| Terms of Services</a>
    ...
    <div class="bottom-nav" id="bottom-nav">
      <form class="search-form" style="width: 100%; justify-content: center" method="GET" action="./html/search.php">
      ...
      <div class="upper-nav-right">
        ...
        <?php
          if (!empty(isset($_SESSION['email']))) {
           echo ' <a href="./html/newcart.php" class="cart-icon"><i class="fa fa-shopping-cart cart"></i></a>';
           echo  '<a href="./html/userProfile.php" class="user-icon"><i class="fa fa-user user"></i></a>';
          }          
        ?>
...
<script>
    ...
    const viewCat = (cat)=>{
    window.open(`./html/search.php?category=${cat}&go=`,'_self');
    };
